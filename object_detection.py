...
class Object_Detection(object):
    ...
    def draw_boxes(self,image, boxes, class_names, scores, max_boxes=5, min_score=0.25):
        colors = list(ImageColor.colormap.values())

        try:
            font = ImageFont.truetype("/usr/share/fonts/liberation/LiberationMono-Regular.ttf",25)
        except IOError:
    ...
    def run_detector(self,detector, path):
        ...
        print("Interface time: ", end_time-start_time)
